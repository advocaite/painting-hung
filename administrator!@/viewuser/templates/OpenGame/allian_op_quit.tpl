<div id="box1">
  <div id="box2">
    <h1>{valu_allain}</h1>
    <p class=\"title_menu\"><a href="allianz.php">{Overview}</a> | <a href="allianz.php?s=10">{giao_tranh}</a> | <a href="allianz.php?s=11">{News}</a> | <a href="allianz.php?s=12">{Options}</a></p>
    <form method="post" action="allianz.php?event=8&act=1">
      <table class="tbg" style="width: 50%;" cellpadding="2" cellspacing="1">
        ...
        <tr>
          ...
          <td colspan="2" class="s7 selected"><a href="allianz.php?event=8">{Quit alliance}</a></td>
        </tr>
        </tbody>
      ...
      <table class="tbg" style="width: 50%;" cellpadding="2" cellspacing="1">
        ...
        <tbody>
          <tr class="rbg">
            <td colspan="2">{Quit alliance}</td>
          </tr>
          <tr>
            <td colspan="2" class="jus">{Quit alliance description}</td>
          </tr>
          <tr class="s7">
            <td>{Password}:</td>
