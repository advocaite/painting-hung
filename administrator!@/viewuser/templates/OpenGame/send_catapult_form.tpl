...
<td width="74%" class="s7"><a href="village_map.php?a={x}&b={y}"><b>{village_defend_name}</b> (<b>{village_defend_x}</b>|<b>{village_defend_y}</b>)</a></td>
</tr>
<tr>
<td>{Player}:</td>
...
<tr>
  ...
  <td colspan="12" class="s7">{Catapults do not fire during raids}</td>
</tr>
