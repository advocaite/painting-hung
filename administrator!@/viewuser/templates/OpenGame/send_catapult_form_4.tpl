...
<td width="80%" class="s7"><a href="village_map.php?a={x}&b={y}"><b>{village_defend_name}</b> (<b>{village_defend_x}</b>|<b>{village_defend_y}</b>)</a></td>
</tr>
<tr>
<td>{Player}:</td>
...
<option value="-2" selected>{Random}</option><option value="1">{Woodcutter}</option><option value="2">{Cropland}</option><option value="3">{Iron_Mine}</option><option value="4">{Clay_Pit}</option><option value="5">{Grain_Mill}</option><option value="6">{Sawmill}</option><option value="7">{Brickyard}</option><option value="8">{Iron_Foundry}<option value="10">{Warehouse}</option><option value="11">{Granary}</option><option value="12">{Main_Building}</option><option value="13">{Marketplace}</option><option value="14">{Embassy}</option><option value="18">{Palace}</option><option value="20">{Trade_Office}</option><option value="24">{Blacksmith}</option><option value="27">{Rally_Point}</option><option value="28">{Barracks}</option><option value="29">{Stable}</option><option value="30">{Workshop}</option><option value="31">{Academy}</option><option value="35">{Hero_Mansion}</option><option value="36">{City_Wall}</option>
<option value="37">{World_wonder}</option>
</select> 
...
<td colspan="12" class="s7">
<select name="kata2" size="" class="f8">
<option value="-2" selected>{Random}</option><option value="1">{Woodcutter}</option><option value="2">{Cropland}</option><option value="3">{Iron_Mine}</option><option value="4">{Clay_Pit}</option><option value="5">{Grain_Mill}</option><option value="6">{Sawmill}</option><option value="7">{Brickyard}</option><option value="8">{Iron_Foundry}<option value="10">{Warehouse}</option><option value="11">{Granary}</option><option value="12">{Main_Building}</option><option value="13">{Marketplace}</option><option value="14">{Embassy}</option><option value="18">{Palace}</option><option value="20">{Trade_Office}</option><option value="24">{Blacksmith}</option><option value="27">{Rally_Point}</option><option value="28">{Barracks}</option><option value="29">{Stable}</option><option value="30">{Workshop}</option><option value="31">{Academy}</option><option value="35">{Hero_Mansion}</option><option value="36">{City_Wall}</option>
<option value="37">{World_wonder}</option>
</select>
<span class="f8">{(will be attacked by catapult(s))}</span></td>
