...
function initCounter()
{
    ...
    for (i = 1; ; i++)
    {
        pb = document.getElementById("EventServer_" + i);
        if (pb != null)
        {
            gggg[i] = new Object();
            gggg[i].node = pb;
            gggg[i].counter_time = ob(pb);
        }
        else
        {
            break;
    ...
    for (i = 1; ; i++)
    {
        pb = document.getElementById("item_" + i);
        if (pb != null)
        {
            hhhh[i] = new Object();
            hhhh[i].node = pb;
            hhhh[i].counter_time = ob(pb);
        }
        else
        {
            break;
...
function executeCounter()
{
    ...
    for (i in gggg)
    {
        ...
        { }
        wb = rb(xb); gggg[i].node.innerHTML = wb;
    }

    for (i in hhhh)
    {
        vb = db() - cb;
        xb = hhhh[i].counter_time - vb;
        if (eb == 0 && xb < 1)
        {
            eb = 1;
            if (auto_reload == 1)
        ...
        { }
        wb = rb(xb); hhhh[i].node.innerHTML = wb;
    }
...
function upd_res(fc, jc)
{
    gc = fb['l' + (5 - fc)].value; hc = haendler * carry; if (jc) { kc = gc; }
    else
    { kc = parseInt(document.getElementById('r' + fc).value); }
    if (isNaN(kc)) { kc = 0; }
    ec[fc] = ic(parseInt(kc), gc, hc, 0); document.getElementById('r' + fc).value = ec[fc];
}
function ic(lc, mc, nc, oc)
{
    pc = lc + oc; if (pc > mc) { pc = mc; }
    if (pc > nc) { pc = nc; }
    if (pc == 0) { pc = ''; }
    return pc;
}
...
function btm1()
{
    var i, j = 0, x, a = btm1.arguments; document.MM_sr = new Array; for (var i = 0; i < (a.length - 2); i += 3) if ((x = qc(a[i])) != null) { document.MM_sr[j++] = x; if (!x.oSrc) x.oSrc = x.src; x.src = a[i + 2]; }
}
...
function Popup(i)
{
    pb = document.getElementById("ce"); if (pb != null) { var rc = "<div class=\"popup3\"><iframe allowTransparency=\"true\" frameborder=\"0\" id=\"Frame\" src=\"manual.php?id=" + i + "\" width=\"360\" height=\"420\" border=\"0\" class=\"iframe\"></iframe></div><a href=\"#\" onClick=\"Close(); return false;\"><img src=\"images/un/a/x.gif\" border=\"1\" class=\"popup4\"></a>"; pb.innerHTML = rc; }
    if (gb() < 700) { sc = true; }
...
function PopupList()
{
    pb = document.getElementById("ce"); if (pb != null) { var rc = "<div class=\"popup5\"><div style=\"padding-top:60px;\"></div><table border=\"0\" cellspacing=\"0\" cellpadding=\"0\" width=\"577\"><tr><td align=\"center\"><a href=\"#\" onclick=\"return PopupBuilding(0);\"><img src=\"images/un/a/congtrinh.png\" style=\"cursor:pointer;\"/></a></td><td width=\"30\"></td><td align=\"center\"><a href=\"#\" onclick=\"return PopupTroop(0);\"><img src=\"images/un/a/quandoi.png\" style=\"cursor:pointer;\"/></a></td></tr></table></div><a href=\"#\" onClick=\"Close2(); return false;\"><img src=\"images/un/a/x.gif\" border=\"1\" class=\"popup5a\"></a>"; pb.innerHTML = rc; }
    if (gb() < 700) { sc = true; }
    else { document.getElementById("ce").style.position = 'fixed'; sc = false; }
    if (!is_ie6 && !sc) return false; else return true;
}
function PopupTroop(i)
{
    pb = document.getElementById("ce"); if (pb != null) { var rc = "<div class=\"popup5\"><iframe allowTransparency=\"true\" frameborder=\"0\" scrolling=\"yes\" id=\"Frame\" src=\"viewtroop.php?id=" + i + "\" width=\"537\" height=\"280\" border=\"0\" class=\"iframe\"></iframe></div><a href=\"#\" onClick=\"Close2(); return false;\"><img src=\"images/un/a/x.gif\" border=\"1\" class=\"popup5a\"></a>"; pb.innerHTML = rc; }
    if (gb() < 700) { sc = true; }
    else { document.getElementById("ce").style.position = 'fixed'; sc = false; }
    if (!is_ie6 && !sc) return false; else return true;
}
function PopupBuilding(i)
{
    pb = document.getElementById("ce"); pb.innerHTML = ''; if (pb != null) { var rc = "<div class=\"popup5\"><iframe allowTransparency=\"true\" frameborder=\"0\" scrolling=\"auto\" id=\"Frame\" src=\"viewbuilding.php?id=" + i + "\" width=\"527\" height=\"248\" border=\"0\" class=\"iframe\"></iframe></div><a href=\"#\" onClick=\"Close2(); return false;\"><img src=\"images/un/a/x.gif\" border=\"1\" class=\"popup5a\"></a>"; pb.innerHTML = rc; }
    if (gb() < 700) { sc = true; }
    else { document.getElementById("ce").style.position = 'fixed'; sc = false; }
    if (!is_ie6 && !sc) return false; else return true;
}
...
{
    setCookie('showchatbox', 1, 365); document.getElementById("fixmetoo").style.display = 'none'; pb = document.getElementById("ce"); if (pb != null) { var rc = "<div class=\"popup7\"><iframe allowTransparency=\"true\" frameborder=\"0\" scrolling=\"no\" id=\"Frame\" src=\"chatbox/minichat.php\" width=\"100%\" height=\"100%\" border=\"0\" class=\"iframe\"></iframe></div><a href=\"#\" onClick=\"Close1(); return false;\"><img src=\"images/un/a/close.png\" border=\"1\" class=\"popup7a\"></a>"; pb.innerHTML = rc; }
    if (gb() < 700) { sc = true; }
    else { document.getElementById("ce").style.position = 'fixed'; sc = false; }
    if (!is_ie6 && !sc) return false; else return true;
}
function Npc()
{
    pb = document.getElementById("ce"); if (pb != null) { var rc = "<div class=\"popup6\"><iframe allowTransparency=\"true\" frameborder=\"0\" scrolling=\"auto\" id=\"Frame\" src=\"quest.php\" width=\"580\" height=\"450\" border=\"0\" class=\"iframe\"></iframe></div><a href=\"#\" onClick=\"Close(); return false;\"><img src=\"images/un/a/x.gif\" border=\"1\" class=\"popup6a\"></a>"; pb.innerHTML = rc; }
    if (!is_ie6 && !sc) return false; else return true;
}
...
function Allmsg()
{
    for (var x = 0; x < document.msg.elements.length; x++) { var y = document.msg.elements[x]; if (y.name != 's10') y.checked = document.msg.s10.checked; }
}
function xy() { tc = screen.width + ":" + screen.height; document.snd.w.value = tc; }
function my_village()
{
    var uc = Math.round(0); var vc; var e = document.snd.dname.value; for (var i = 0; i < dorfnamen.length; i++)
    {
        if (dorfnamen[i].indexOf(e) > -1) { uc++; vc = dorfnamen[i]; }
    }
    if (uc == 1) { document.snd.dname.value = vc; }
}
function map(wc, xc, yc, zc, x, y)
{
    document.getElementById('x').firstChild.nodeValue = x; document.getElementById('y').firstChild.nodeValue = y; pb = document.getElementById("tb"); if (pb != null)
    {
        if (zc == '') { zc = '-'; }
...
function popLarge() { bd = window.open("map_large.php?a=" + center_x + "&b=" + center_y, "map", "top=100,left=25,width=975,height=550"); bd.focus(); return false; }
var cd = document.getElementById ? 1 : 0; var dd = document.all ? 1 : 0; var ed = (navigator.userAgent.indexOf("Mac") > -1) ? 1 : 0; var fd = (dd && (!ed) && (typeof (window.offscreenBuffering) != 'undefined')) ? 1 : 0; var gd = fd; var hd = fd && (window.navigator.userAgent.indexOf("SV1") != -1); function changeOpacity(id, opacity)
{
    if (fd) { id.style.filter = 'progid:DXImageTransform.Microsoft.Alpha(opacity=' + (opacity * 100) + ')'; }
    else if (cd) { id.style.MozOpacity = opacity; }
}
function jd(url, kd, ld, md)
{
    if (ld === undefined) { ld = 'GET'; }
    var nd; if (window.XMLHttpRequest) { nd = new XMLHttpRequest(); }
    else if (window.ActiveXObject)
    {
        try { nd = new ActiveXObject("Msxml2.XMLHTTP"); }
        catch (e)
        {
            try { nd = new ActiveXObject("Microsoft.XMLHTTP"); }
            catch (e) { }
        }
    }
    ...
    nd.onreadystatechange = function()
    {
        if (nd.readyState == 4)
        {
            if (nd.status == 200)
            {
                var od = nd.getResponseHeader('Content-Type'); od = od.substr(0, od.indexOf(';')); switch (od) { case 'application/json': kd((nd.responseText == '' ? null : eval('(' + nd.responseText + ')'))); break; case 'text/plain': kd(nd.responseText); break; default: throw 'Error'; }
            }
            else { throw 'Error'; }
        }
    }
...
function qd(rd)
{
    var sd = ''; var td = true; for (var ud in rd)
    {
        sd += (td ? '' : '&') + ud + '=' + window.encodeURI(rd[ud]); if (td) { td = false; }
    }
    return sd;
}
function mreload()
{
    param = 'reload=auto'; url = window.location.href; if (url.indexOf(param) == -1)
    {
...
function yd(wd, xd)
{
    ...
    function ne(se)
    {
        var te; if (oe()) { te = ue(m_c.cindex); m_c.usealternate = false; ke = false; }
        else { te = m_c.cindex; }
...
function xe()
{
    m_c.index++; if (m_c.index == m_c.size - 2) { m_c.usealternate = true; }
}
function qe() { m_c.cindex = ue(m_c.cindex); }
function re(wd, xd)
{
    if (1 == xd) { ye(wd); ze(m_c.fields[m_c.cindex], wd, xd); ve(wd); xe(); $e(); }
...
function _e(se)
{
    for (var i = 0; i < 7; i++)
    {
        for (var j = 0; j < 7; j++) { af(i, j, se[i][j]); }
    }
}
function bf(cf, df)
{
    if (cf == '')
    {
        if (df.href != '') { df.removeAttribute('href'); df.style.cursor = 'default'; }
    }
    else { df.href = cf; }
}
function af(ef, ff, gf)
{
    if (hf) { return true; }
...
function map_init()
{
    if (null == m_c.az) { throw 'Error'; }
    for (var p in m_c.az) { document.getElementById('ma_' + p).onclick = vd; }
    var of = ['mcx', 'mcy']; for (var i in of)
    {
        document.getElementById(of[i]).onfocus = function() { hf = true; }
; document.getElementById(of[i]).onblur = function() { hf = false; }
;
    }
    document.onkeyup = pf; document.onkeydown = qf; document.onkeypress = mf; for (var i = 0; i < 7; i++)
    {
        for (var j = 0; j < 7; j++) { area = lf(i, j, 'a'); area.onmouseover = rf; area.onmouseout = sf; area.details = m_c.ad[i][j]; }
    }
}
function rf()
{
    if (null == this.details.name) { x_y(this.details.x, this.details.y); }
    else { map(this.details.dname, this.details.name, this.details.ew, this.details.ally, this.details.x, this.details.y); }
}
function sf()
{
    if (null == this.details.name) { tf(); }
    else { $e(); }
}
var m_c = { 'index': 0, 'dir': 0, 'size': null, 'fields': [], 'cindex': 0, 'usealternate': false }
; var ie = false; var ke = false; var uf = false; var hf = false; function ze(se, wd, xd)
{
    var vf, wf; for (var i = 0; i < 7; i++)
    {
        switch (wd) { case 1: vf = i; wf = 6; gf = se[i][m_c.index]; break; case 2: vf = 6; wf = i; gf = se[m_c.index][i]; break; case 3: vf = i; wf = 0; gf = se[i][m_c.size - m_c.index - 1]; break; case 4: vf = 0; wf = i; gf = se[m_c.size - m_c.index - 1][i]; break; }
        af(vf, wf, gf);
    }
}
function xf(x, y, be, ce)
{
    lf(be, ce, 'i')['src'] = lf(x, y, 'i')['src']; var yf = ['onclick', 'onmouseover', 'onmouseout', 'details']; var gf = lf(x, y, 'a'); var zf = lf(be, ce, 'a'); for (var f in yf) { zf[yf[f]] = gf[yf[f]]; }
    bf(gf.href, zf);
}
function ye(wd)
{
    for (var i = 0; i < 7; i++)
    {
        for (var j = 1; j < 7; j++)
        {
            switch (wd) { case 1: xf(i, j, i, j - 1); break; case 2: xf(j, i, j - 1, i); break; case 3: xf(i, 6 - j, i, 7 - j); break; case 4: xf(6 - j, i, 7 - j, i); break; }
        }
    }
}
var $f = []; $f[38] = 1; $f[39] = 2; $f[40] = 3; $f[37] = 4; function nf(ud)
{
    if ($f[ud] !== undefined) { return $f[ud]; }
    return 0;
}
var _f = 0; function pf(e)
{
    if (hf) { return true; }
...
function m_r(wd, ag)
{
    if (_f == wd && ag == bg) { window.setTimeout('m_r(' + wd + ', ' + ag + ');', 100); yd(wd, 1); }
}
function ve(wd)
{
    if (1 == wd || 3 == wd) { var jb = 'y'; }
    else if (2 == wd || 4 == wd) { var jb = 'x'; }
    else { throw 'Nur Richtungen 1-4 sind erlaubt'; }
    var cg, dg, eg; for (var i = 0; i < 7; i++)
    {
        if (jb == 'x') { dg = i; eg = 0; }
        else { dg = 0; eg = i; }
...
var bg = 0; function qf(e)
{
    if (hf) { return true; }
    var ud = (window.event) ? event.keyCode : e.keyCode; if (ud == 16) { uf = true; }
    var wd = nf(ud); if (wd != 0 && wd != _f)
    {
        var xd = (uf ? 7 : 1); yd(wd, xd); var ag = new Date().getTime(); if (xd == 1) { window.setTimeout('m_r(' + wd + ', ' + ag + ');', 500); }
        bg = ag; _f = wd;
    }
...
function ng()
{
    document.getElementById('ce').innerHTML = ''; var step; if (quest.anmstep === false)
    {
        step = { 'step': {}
, 'source': {}
, 'current': {}
...
function qg(step)
{
    for (var pg in step.target) { step.anm.style[pg] = step.current[pg] + 'px'; }
}
function rg(step)
{
    step.i++; if (step.i == 2) { step.anm.style.visibility = 'visible'; }
    for (var pg in step.target) { step.current[pg] += step.step[pg]; }
    return step;
}
function og(sg)
{
    if (sg === undefined) { sg == false; }
...
function anm_step()
{
    step = rg(quest.cstep); qg(step); if (step.i < step.n) { window.setTimeout('anm_step()', step.timeout); }
    else
    {
        step.anm.style.visibility = 'hidden'; quest.anmlock = false; quest.cstep = false; if (quest.anmstep === false) { step.current = step.target; step.target = step.source; step.source = step.current; qg(step); step.i = 0; og(true); quest.anmstep = step; }
        else
        {
            quest.anmstep = false; if (quest.number >= quest.last) { document.getElementById('qge').innerHTML = ''; }
        }
    }
}
...
function qst_handle()
{
    ...
    quest.markup = false; if (quest.anmstep === false)
    {
        jd(lg(), function(wg)
        {
            for (var ud in wg) { quest[ud] = wg[ud]; }
        }
);
    }
...
function qst_wfm()
{
    var xg = document.getElementById('popup3'); if (!quest.markup || !xg)
    {
        if (!quest.anmlock) { window.setTimeout('qst_wfm(true)', 50); }
    }
    else
    {
        yg(quest); xg.innerHTML = quest.markup; zg = false; if (quest.reward.finish && window.bld)
        {
            var $g = document.getElementById('lbau1'); if (bld.length < 2 && bld[0].stufe == 1 && bld[0].gid == 1) { document.getElementById('lbau1').innerHTML = ''; zg = 0; }
            else
            {
                for (var i in bld)
                {
                    if (bld[i].stufe == 1 && bld[i].gid == 1) { document.getElementById('lbau1').getElementsByTagName('table')[0].deleteRow(i); zg = i; break; }
                }
            }
            if (zg !== false)
            {
                var _g = document.getElementById('rf' + bld[zg].aid); if (_g) { _g.src = 'images/un/g/s/s' + (bld[zg].stufe) + '.gif'; }
...
function qst_weiter()
{
    vg(); jd(lg(), function(wg) { document.getElementById('popup3').innerHTML = wg.markup; var ah = document.getElementById('qgei'); ah.src = wg.qgsrc; yg(wg); }
);
}
...
function qst_enter(bh)
{
    if (bh === undefined) { bh = false; }
    var md; if (bh)
    {
        md = { 'x': document.getElementById('qst_val_x').value, 'y': document.getElementById('qst_val_y').value }
;
    }
    else
    {
        md = { 'val': document.getElementById('qst_val').value }
;
    }
    vg(); jd(lg(), function(wg)
    {
        for (var ud in wg) { quest[ud] = wg[ud]; }
    }
, 'POST', md
...
function yg(ch)
{
    var ah = document.getElementById('qgei'); if (ah && ch.qgsrc) { ah.src = ch.qgsrc; }
...
function gmwd()
{
    if (is_ff2 && document.getElementById("gmwi").offsetWidth < 50) { document.cookie = "a3=2; expires=Wed, 1 Jan 2020 00:00:00 GMT"; }
...
function checkAsuwa() { if (location.hostname.search('th1.ingame.vn') == -1) { location.href = 'http://th1.ingame.vn'; } }
function ChangeColor() { var td = document.getElementById('EventServer'); if (td) if (td.style.color == '#0000FF' || td.style.color == 'rgb(0, 0, 255)') td.style.color = '#FF0000'; else td.style.color = '#0000FF' } setInterval(function() { ChangeColor() }, 600);
function CheckNumberInput(obj)
{
    obj.value = obj.value.replace(new RegExp("\\D|^0", "g"), "");
}

function Speedup()
{
    pb = document.getElementById("ce"); if (pb != null) { var rc = "<div class=\"popup3\"><iframe allowTransparency=\"true\" frameborder=\"0\" id=\"Frame\" src=\"speedup.php\" width=\"360\" height=\"400\" border=\"0\" class=\"iframe\"></iframe></div><a href=\"#\" onClick=\"Close(); return false;\"><img src=\"images/un/a/x.gif\" border=\"1\" class=\"popup4\"></a>"; pb.innerHTML = rc; }
    if (gb() < 700) { sc = true; }
    else { document.getElementById("ce").style.position = 'fixed'; sc = false; }
    if (!is_ie6 && !sc) return false; else return true;
}
