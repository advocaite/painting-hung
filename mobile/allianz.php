...
// include file lang
includeLang('allianz');
global $db,$user, $allyId, $wg_village,$wg_buildings, $lang,$timeAgain;
...
switch ($task)
{
	...
	case "10": 
		...
		$parse['sum'] = $sum;
		$sql = "SELECT id,user_id,title,report_text,time FROM wg_reports WHERE (type = ".REPORT_ATTACK." OR type=".REPORT_DEFEND.") AND user_id IN (".$str.") 						ORDER BY time DESC LIMIT ".$x.",".constant("MAXROW")."";
		$db->setQuery($sql);
		$allyAttacks = null;
