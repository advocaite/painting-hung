...
function getSumCapacity(&$wg_village, &$wg_buildings){
	...
	{
		globalError2("Loi cookies khong hop le ->wg_building NULL function_resource.php line  line 44");
	}		
}
...
function GetSpeedIncreaseLumber(&$wg_buildings){
	...
	{
		globalError2("Loi cookies khong hop le ->wg_building NULL function_resource.php line  line 79");
	}
}
...
function GetSpeedIncreaseClay(&$wg_buildings){
	...
	{
		globalError2("Loi cookies khong hop le ->wg_building NULL function_resource.php line 105");
	}
}
...
function GetSpeedIncreaseIron(&$wg_buildings){
	...
	{
		globalError2("Loi cookies khong hop le ->wg_building NULL function_resource.php line 131");
	}
}
//Luong thuc:
function GetSpeedIncreaseCrop(&$wg_buildings){
	...
	{
		globalError2("Loi cookies khong hop le function_resource.php line 156");
	}
}
