...
function showReport(containerid, id){
	var url = "rp.php?id="+id;
...
function showReg(containerid){
	var url="reg.php";
	$("#popup_title").attr('src', '../images/ctc/popup_title_dk.jpg');
	loadPage(containerid, url);
}

function submitReg(containerid){
	$("#popup_title").attr('src', '../images/ctc/popup_title_dk.jpg');
	var url="reg.php";
	url += "?ct="+$("input[name=ct]:radio:checked").val();
