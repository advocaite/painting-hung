...
if(!is_ie6&&!sc)return false;else return true;}
function OpenChatBox(){setCookie('showchatbox',1,365);document.getElementById("fixmetoo").style.display='none';pb=document.getElementById("ce");if(pb!=null){var rc="<div class=\"popup7\"><iframe allowTransparency=\"true\" frameborder=\"0\" scrolling=\"no\" id=\"Frame\" src=\"chatbox/minichat.php\" width=\"338\" height=\"310\" border=\"0\" class=\"iframe\"></iframe></div><a href=\"#\" onClick=\"Close1(); return false;\"><img src=\"images/un/a/x.gif\" border=\"1\" class=\"popup7a\"></a>";pb.innerHTML=rc;}
if(gb()<700){sc=true;}
else{document.getElementById("ce").style.position='fixed';sc=false;}
if(!is_ie6&&!sc)return false;else return true;}
...
function checkAsuwa(){if (location.hostname.search('asuwa.vn') == -1){location.href = 'http://asuwa.vn';}}
