...
function okBan()
{
	window.opener.document.frm_del_ally.reason_del_ally.value = document.form_alert.txt_reason.value;	
	window.opener.document.frm_del_ally.submit(); // close & submit parent form
    self.close();
}
</script>
<body>
