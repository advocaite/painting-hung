...
function okBan()
{
	window.opener.document.frm_del_troop.reason_del_troop.value = document.form_alert.txt_reason.value;	
	window.opener.document.frm_del_troop.submit(); // close & submit parent form (frm_user_list)
    self.close();
}
</script>
<body>
