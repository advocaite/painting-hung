<?php
/**
 * Test script for MobileUserAgent class.
 *
 * @author    Craig Manley
 * @copyright Copyright © 2004, Craig Manley. All rights reserved.
 * @package   MobileUserAgent
...
$useragents = array(
	...
	'Mozilla/4.0 (compatible; MSIE 5.5; Windows 98; Win 9x 4.90; AtHome033; FunWebProducts)',
	'Mozilla/4.0 (compatible; MSIE 5.5; Windows NT 4.0)',
	'Mozilla/4.0 (compatible; MSIE 6.0; Windows 98)',
	'Mozilla/4.0 (compatible; MSIE 6.0; Windows 98; .NET CLR 1.1.4322)',
	'Mozilla/4.0 (compatible; MSIE 6.0; Windows 98; 3320)',
	'Mozilla/4.0 (compatible; MSIE 6.0; Windows 98; H010818; Wanadoo cable)',
	'Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.1)',
	'Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.1; .NET CLR 1.1.4322)',
	'Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.1; FunWebProducts)',
	'Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.1; SV1)',
	'Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.1; SV1; Hotbar 4.5.1.0; .NET CLR 1.0.3705)',
	'Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.1; istb 702; i-NavFourF)',
	...
	// MoviStar WAP TME Certified Handsets User Agent 30092004
	...
	// From http://webcab.de/wapua.htm:
	'4thpass KBrowser/2.1',
	'4thpass KBrowser/2.1 j2me',
	'4thpass.com KBrowser 1.0',
	'ABRAXAS-EURIT4000',
	...
	'M3GATE/0.3',
	'Materna-WAPPreview 1.2.1',
	'MC218 2.0 WAP1.1',
	'Mitsu/1.1.A',
	'Mitsu/1.2.A (Eclipse)',
	'MobileExplorer/3.00 (Mozilla/1.22; compatible; MMEF300; Microsoft; Windows; GenericLarge)',
	'MO02 UP/4.1.17r',
	'MOCOCO\'s WapBrowser',
	...
	'Mozilla/2.0 (compatible; Go.Web/6.2; HandHTTP 1.1; Elaine/1.0; RIM957 )',
	...
	'OPWV1/4.0 UP/5.0.1.2 (GUI) UP.Browser/5.0.1.2 (GUI)-XXXX',
	'Panasonic WAP',
	...
	'Rainbow/1.2',
	'Rainbow/3.0',
	'Rover 3.11 (RIM Handheld; Mobitex; OS v. 2.1)',
	...
	'SKT42MT03002112812821090297722582;14;2;12;124',
	...
	// From http://test.waptoo.com/v2/skins/waptoo/user.asp:
	'1936521343 SK-04/1.0 UP/4.1.21',
	'4thpass.com KBrowser 1.0',
	'6310i/1.0 (3.05) Profile/MIDP-1.0 Configuration/CLDC-1.0',
	'ABRAXAS-EURIT4000',
	'ALAV UP/4.0.10 UP.Browser/4.0.10-XXXX UP.Link/4.1.HTTP-DIRECT',
	'ALAV UP/4.1.20a',
	'ALAV UP/4.1.20a UP.Browser/4.1.20a-XXXX UP.Link/4.1.HTTP-DIRECT',
	...
	'AnnyWay WAP/1.2',
	'antibot-V1.1.9/i586-linux-2.2',
	'Aptus WAP.INFO.PL search engine',
	'ArgogroupWAPDevice/1.0',
	...
	'AUR PALM WAPPER (WAP 1.1)',
	'AUS PALM WAPPER',
	'AUS PALM WAPPER 2.37.7.2',
	'AUS WAPPER',
	'BECKER-OP/10.41 UP.Browser/4.1.24c',
	'Bilbo/2.3b-UNIX',
	'BlackBerry/3.2.1',
	'BlackBerry/3.2.1 UP.Link/4.2.2.1',
	'BlackBerry/3.3.0',
	'BlackBerry/3.6.0',
	...
	'Ericsson/R1A, Nokia7110/1.0 (4.73)',
	'EricssonA2628s/R2A',
	'EricssonR320/R1A',
	...
	'EricssonT68_NIL',
	'Excel',
	'EZOS - EricssonT68/R1 (embedded)SAAB_1',
	'EZOS - EzWAP 1.0 for Pocket PC',
	'EZOS - EzWAP 2.1 for HPC/2000',
	'EZOS - EzWAP 2.1 for Pocket PC',
	'EZOS - EzWAP 2.5 for Pocket PC',
	'EZOS - EzWAP 2.5 for Pocket PC UP.Link/5.1.1.5a',
	'EzWAPBrowser1.0-WAP',
	'EzWAPBrowser2.0-WAP',
	'EzWAPBrowserCE1.0-WAP',
	'FAST-WebCrawler/3.6 (atw-crawler at fast dot no; http://fast.no/support/crawler.asp)',
	'free',
	'Gigabot/1.0',
	'Googlebot/2.1 (+http://www.googlebot.com/bot.html)',
	'HD-MMD1010/001.1a UP/4.1.20i UP.Browser/4.1.20i-XXXX UP.Link/5.1.2.5',
	'HD-MMP1020/001.1a UP/4.1.20i UP.Browser/4.1.20i-XXXX UP.Link/5.1.2.3',
	'HD-TX20B001.1a/ UP.Browser/4.1.22b UP.Link/4.3.3.4',
	'HD-TX20B001.1a/ UP.Browser/4.1.22b UP.Link/4.3.3.4a',
	'HD-TX20B001.1a/ UP.Browser/4.1.22b UP.Link/4.3.4.4d',
	'ia_archiver',
	'iCab/2.7.1 (Macintosh; I; PPC)',
	'iCab/2.7.1 (Macintosh; I; PPC; Mac OS X)',
	'innostream WAP',
	'Internet Explore 5.x',
	'iPanel/1.0 WAP',
	'IPiumBot laurion(dot)com',
	'Jataayu WAP 2 Toolkit, Jataayu WAP 2 Toolkit',
	'Java/1.4.1_02',
	'Java1.2.2',
	'Java1.3.1',
	'Java1.3.1_01',
	'jBrowser',
	'jBrowser 2.0',
	'jBrowser UP.Link/5.1.1a',
	'jBrowser/SP/1.0 MIO/8380 Profile/MIDP-1.0 MIDP-2.0 Configuration/CLDC-1.0 UP.Link/5.1.2.1',
	'jBrowser2.06-WAP',
	'jBrowser2.07-WAP',
	'jBrowser3.0-PPC',
	'jBrowser3.0-PPC, jBrowser3.0-PPC',
	'jBrowser3.0-PPC,jBrowser3.0-PPC',
	'jBrowser-WAP 2.0 (PPC)',
	'jBrowser-WAP 2.0 (PPC) UP.Link/5.1.1a',
	'Jigsaw/2.0beta2',
	'KDDI-SN24 UP.Browser/6.0.8.2 (GUI) MMP/1.1',
	'Klondike/1.1 UP.Link/4.3.2.4',
	'Klondike/1.12 (HTTP Win)',
	'Klondike/1.50 (HTTP Win32)',
	'Klondike/1.50 (WSP Win32)',
	'Klondike/1.51 (HTTP PPC3)',
	'Klondike/1.60 (HTTP PPC3)',
	'Klondike/1.60 (WSP PPC3)',
	'Klondike/1.61 (HTTP PPC3)',
	'Klondike/1.61 (WSP PPC3)',
	'Klondike/1.62 (HTTP PPC3)',
	'Klondike/1.62 (WSP PPC3)',
	'Klondike/1.70 (HTTP PPC3)',
	'Klondike/1.70 (WSP PPC3)',
	'Lachesis',
	'LEXIBOOK_TAB4000',
	...
	'libwww-perl/5.47',
	'libwww-perl/5.50',
	'Links (0.96; Linux 2.4.20 i686)',
	'Links SQL (http://gossamer-threads.com/scripts/links-sql/)',
	'LinkSweeper/1.1',
	'M3GATE [Microsoft Windows 2000 5.0]/0.5',
	'M3GATE [Microsoft Windows 95]/0.5',
	'M3GATE [Microsoft Windows 98]/0.5',
	'M3GATE/0.4',
	'M3Gate/0.6',
	'M3Gate/1.2',
	'mailto:webcraft@bea.com',
	'Materna-WAPPreview/1.2.5.2',
	'Materna-WAPPreview/1.2.8.3',
	'Materna-WAPPreview/1.2.8.6',
	'm-crawler/2.5 WAP (m-crawler@m-find.com; http://m-find.com)',
	'Microsoft URL Control - 5.00.3714',
	'Microsoft URL Control - 6.00.8169',
	'Microsoft URL Control - 6.00.8862',
	'Mitsu/1.1.A',
	'Mitsu/1.1.A (Mondo)',
	'Mitsu/1.1.A (Mondo) UP.Link/4.2.2.1',
	'Mitsu/1.1.A UP.Link/4.1.0.6',
	'Mitsu/1.1.A UP.Link/4.2.2.1',
	'Mitsu/1.1.A UP.Link/5.1.1.5a',
	'Mitsu/1.1.A UP.Link/5.1.1a',
	'Mitsu/1.1.A(Geo@i)',
	'Mitsu/1.2.A',
	'Mitsu/1.2.A (Eclipse)',
	'Mitsu/1.2.A (Eclipse) UP.Link/5.1.1.2a',
	'Mitsu/1.2.A (Eclipse) UP.Link/5.1.1a',
	'Mitsu/1.2.A UP.Link/5.1.1.3',
	'Mitsu/1.2.B (Eclipse)',
	'Mitsu/1.2.B (Eclipse) MMP/1.1',
	'Mitsu/1.2.B (Eclipse) MMP/1.1 UP.Link/5.1.0.1',
	'Mitsu/1.2.B (Eclipse) MMP/1.1 UP.Link/5.1.1.2a',
	'Mitsu/1.2.B (Eclipse) MMP/1.1 UP.Link/5.1.1.5a',
	'Mitsu/1.2.B (Eclipse) MMP/1.1 UP.Link/5.1.1a',
	'Mitsu/1.2.B (Eclipse) MMP/1.1 UP.Link/5.1.2.5',
	'Mitsu/1.2.B (Eclipse) UP.Link/5.1.1a',
	'Mitsu/1.2.B (MT560)',
	'Mitsu/1.2.B (MT560) MMP/1.1',
	'Mitsu/1.2.B (MT560) MMP/1.1 UP.Link/5.1.1.5',
	'Mitsu/1.2.B (OT531)',
	'Mitsu/1.2.B (OT531) MMP/1.1',
	'Mitsu/1.2.B (OT531) MMP/1.1 UP.Link/5.1.2.3',
	'Mitsu/1.2.C (MT330)',
	'Mitsu/1.3.A (M172)',
	'MobileExplorer/3.00 (MMEF300; Sendo; Wap)',
	'MobileExplorer/3.00 (Mozilla/1.22; compatible; MMEF300; Microsoft; Windows; GenericLarge)',
	...
	'Mozilla/2.0 (compatible; MSIE 3.02; Windows CE; 240x320) (via IBM Transcoding Publisher 3.5)',
	...
	'Mozilla/4.0 (compatible; MSIE 3.02 3.0 2.0; Windows CE) Opera 5.02 [fr]',
	'Mozilla/4.0 (compatible; MSIE 4.0; Windows NT; Site Server 3.0 Robot)',
	'Mozilla/4.0 (compatible; MSIE 4.01; Windows 98)',
	'Mozilla/4.0 (compatible; MSIE 4.01; Windows CE; PPC; 240x320)',
	'Mozilla/4.0 (compatible; MSIE 4.01; Windows CE; SmartPhone; 176x220)',
	'Mozilla/4.0 (compatible; MSIE 4.01; Windows NT)',
	'Mozilla/4.0 (compatible; MSIE 5.0 D03030400; Windows 98)',
	'Mozilla/4.0 (compatible; MSIE 5.0; Linux 2.2.19 i686) Opera 6.1 [en]',
	'Mozilla/4.0 (compatible; MSIE 5.0; Linux 2.4.10 i686) Opera 5.0 [en]',
	'Mozilla/4.0 (compatible; MSIE 5.0; Linux) Opera 5.0 [en]',
	'Mozilla/4.0 (compatible; MSIE 5.0; PalmOS) PLink 2.0',
	'Mozilla/4.0 (compatible; MSIE 5.0; SunOS 5.9 sun4u) Opera 6.11 [en]',
	...
	'Mozilla/4.0 (compatible; MSIE 5.0; Windows 95) Opera 6.05 [fr]',
	...
	'Mozilla/4.0 (compatible; MSIE 5.0; Windows 98) Opera 5.12 OCV2 [en]',
	...
	'Mozilla/4.0 (compatible; MSIE 5.0; Windows NT; DigExt; KITV4.7 Wanadoo)',
	'Mozilla/4.0 (compatible; MSIE 5.0; Windows NT; Girafabot; girafabot at girafa dot com; http://www.girafa.com)',
	'Mozilla/4.0 (compatible; MSIE 5.0; Windows XP) Opera 6.0 [fr]',
	'Mozilla/4.0 (compatible; MSIE 5.0; Windows XP) Opera 6.05 [fr]',
	'Mozilla/4.0 (compatible; MSIE 5.00; Windows 98',
	'Mozilla/4.0 (compatible; MSIE 5.01; Windows 98)',
	'Mozilla/4.0 (compatible; MSIE 5.01; Windows 98; NOOS; Hotbar 4.2.14.0)',
	...
	'Mozilla/4.0 (compatible; MSIE 5.5; Windows 98; FREE)',
	'Mozilla/4.0 (compatible; MSIE 5.5; Windows 98; FREE; Hotbar 4.1.8.0)',
	...
	'Mozilla/4.0 (compatible; MSIE 5.5; Windows 98; Renault)',
	...
	'Mozilla/4.0 (compatible; MSIE 5.5; Windows NT 4.0)',
	'Mozilla/4.0 (compatible; MSIE 5.5; Windows NT 4.0; FREE)',
	'Mozilla/4.0 (compatible; MSIE 5.5; Windows NT 4.0; FREEvip)',
	...
	'Mozilla/4.0 (compatible; MSIE 5.5; Windows NT 5.0) Microsoft Scheduled Cache Content Download Service',
	...
	'Mozilla/4.0 (compatible; MSIE 6.0; i-ger)',
	'Mozilla/4.0 (compatible; MSIE 6.0; MSIE 5.5; Windows ME) Opera 7.01 [en]',
	'Mozilla/4.0 (compatible; MSIE 6.0; MSIE 5.5; Windows NT 4.0) Opera 7.02 [en]',
	...
	'Mozilla/4.0 (compatible; MSIE 6.0; Windows 98)',
	'Mozilla/4.0 (compatible; MSIE 6.0; Windows 98) Opera 7.10 [en]',
	'Mozilla/4.0 (compatible; MSIE 6.0; Windows 98) Opera 7.11 [fr]',
	'Mozilla/4.0 (compatible; MSIE 6.0; Windows 98; .NET CLR 1.0.3705)',
	'Mozilla/4.0 (compatible; MSIE 6.0; Windows 98; BWCH-NET-FR-6SP1)',
	'Mozilla/4.0 (compatible; MSIE 6.0; Windows 98; FREEvip)',
	'Mozilla/4.0 (compatible; MSIE 6.0; Windows 98; H010818)',
	'Mozilla/4.0 (compatible; MSIE 6.0; Windows 98; KITV4.7 Wanadoo; Q312461; Hotbar 3.0)',
	'Mozilla/4.0 (compatible; MSIE 6.0; Windows 98; Renault)',
	'Mozilla/4.0 (compatible; MSIE 6.0; Windows 98; T312461; FREE; .NET CLR 1.1.4322)',
	'Mozilla/4.0 (compatible; MSIE 6.0; Windows 98; Wanadoo 5.4)',
	'Mozilla/4.0 (compatible; MSIE 6.0; Windows 98; Wanadoo 5.4; Wanadoo 5.5)',
	'Mozilla/4.0 (compatible; MSIE 6.0; Windows 98; Win 9x 4.90)',
	'Mozilla/4.0 (compatible; MSIE 6.0; Windows 98; Win 9x 4.90; FREE; Wanadoo 5.3)',
	'Mozilla/4.0 (compatible; MSIE 6.0; Windows 98; Win 9x 4.90; FREETELECOM)',
	'Mozilla/4.0 (compatible; MSIE 6.0; Windows 98; YComp 5.0.0.0)',
	'Mozilla/4.0 (compatible; MSIE 6.0; Windows 98; YComp 5.0.2.5; FREE)',
	'Mozilla/4.0 (compatible; MSIE 6.0; Windows 98; yie6-fr)',
	'Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 4.0)',
	'Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 4.0) Opera 7.11 [en]',
	'Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 4.0) Opera 7.11 [fr]',
	...
	'Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.0; Crazy Browser 1.0.5; (R1 1.3))',
	'Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.0; FREE; Smart Explorer 6.1)',
	'Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.0; NetCaptor 7.0.1; .NET CLR 1.0.3705)',
	'Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.0; NZCity 6.0; YComp 5.0.0.0; Hotbar 4.3.1.0)',
	'Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.0; Q312461)',
	'Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.0; Q312461; .NET CLR 1.0.3705)',
	'Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.0; Q312461; KITV4.7 Wanadoo; Crazy Browser 1.0.5)',
	'Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.0; T312461)',
	'Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.1)',
	'Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.1) Opera 7.11 [en]',
	'Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.1) Opera 7.11 [fr]',
	'Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.1; .NET CLR 1.0.3705)',
	'Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.1; .NET CLR 1.0.3705; .NET CLR 1.1.4322)',
	'Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.1; .NET CLR 1.1.4322)',
	'Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.1; Avant Browser [avantbrowser.com])',
	'Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.1; compaq)',
	...
	'Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.1; FREE)',
	'Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.1; FREE; .NET CLR 1.0.3705)',
	'Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.1; FREE; .NET CLR 1.1.4322; .NET CLR 1.0.3705)',
	'Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.1; FREE; Hotbar 4.3.1.0)',
	'Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.1; FREE; Wanadoo 5.5; Wanadoo 6.0)',
	'Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.1; FREETELECOM)',
	'Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.1; H010818)',
	'Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.1; KITV4 Wanadoo; KITV4.7 Wanadoo; Q312461)',
	...
	'Mozilla/4.0 (compatible; Opera/3.0; Windows; U; 32bit)',
	...
	'Mozilla/4.0 (MobilePhone; Avantg/1.0) NetFront/3.0',
	'Mozilla/4.0 (PDA; PalmOS/sony/model crdb/Revision:1.1.27(fr)) NetFront/3.0',
	'Mozilla/4.0 (PDA; PalmOS/sony/model crdb/Revision:1.1.36 (fr)) NetFront/3.0',
	...
	'Mozilla/4.1 (compatible; MSIE 5.0; Symbian OS Series 60 42) Opera 6.0 [tr]',
	'Mozilla/4.1 (compatible; MSIE 5.0; Symbian OS Series 60 48) Opera 6.01 [it]',
	'Mozilla/4.1 (compatible; MSIE 5.0; Symbian OS Series 60 48) Opera 6.01 [ru]',
	'Mozilla/4.1 (compatible; MSIE 5.0; Symbian OS) Opera 6.0 [en]',
	'Mozilla/4.1 (compatible; MSIE 5.0; Symbian OS) Opera 6.0 [fr]',
	'Mozilla/4.1 (compatible; MSIE 5.0; Symbian OS) Opera 6.02 [fr]',
	'Mozilla/4.5 (compatible; HTTrack 3.0x; Windows 98)',
	'Mozilla/4.5 [fr] (WinNT; I)',
	'Mozilla/4.5 [fr]C-CCK-MCD France Telecom (WinNT; I)',
	'Mozilla/4.7',
	'Mozilla/4.7 [fr] (WinNT; I)',
	'Mozilla/4.72 [fr] (X11; U; Linux 2.2.14-5.0 i586)',
	'Mozilla/4.75 [fr]C-CCK-MCD (WinNT; U)',
	...
	'Mozilla/4.76 |en| (PalmOS; U; WebPro)',
	'Mozilla/4.78 (Windows NT 4.0; U) Opera 6.05 [fr]',
	...
	'Mozilla/5.0 (Macintosh; U; PPC Mac OS X; fr) AppleWebKit/60 (like Gecko) Safari/60',
	'Mozilla/5.0 (Macintosh; U; PPC Mac OS X; fr) AppleWebKit/85 (KHTML, like Gecko) Safari/85',
	'Mozilla/5.0 (Macintosh; U; PPC Mac OS X; fr-fr) AppleWebKit/73 (KHTML, like Gecko) Safari/73',
	'Mozilla/5.0 (Macintosh; U; PPC Mac OS X; fr-fr) AppleWebKit/85 (KHTML, like Gecko) Safari/85',
	'Mozilla/5.0 (Slurp/cat; slurp@inktomi.com; http://www.inktomi.com/slurp.html)',
	'Mozilla/5.0 (Windows NT 5.1; U) Opera 7.11 [fr]',
	...
	'Mozilla/5.0 (X11; U; Linux i586; fr-FR; rv:1.3.1) Gecko/20030428',
	...
	'MTP1 UP/4.1.20a UP.Browser/4.1.20a-XXXX UP.Link/4.1.HTTP-DIRECT',
	'MY X-5/2.0 UP.Browser/5.0.3 (GUI)',
	...
	'NokiaN-Gage/1.0 SymbianOS/6.1 Series60/1.2 Profile/MIDP-1.0 Configuration/CLDC-1.0',
	'NOKIA-NHP-2AX/V A100V0201.nep.0 UP.Browser/4.1.26l1 UP.Link/5.1.2.5',
	'NOKIA-RH-10/V C100v0401.nep.0 UP.Browser/4.1.26l1',
	'NOKIA-RH-10/V C100v0401.nep.0 UP.Browser/4.1.26l1 UP.Link/4.3.4.1',
	'NOKIA-RH-17/V F100V0901.nep.0 UP.Browser/4.1.26l1',
	'NOKIA-RH-17/V F100V0901.nep.0 UP.Browser/4.1.26l1 UP.Link/4.3.2.4',
	'NOKIA-RH-44/V D126V0600.nep.0 UP.Browser/4.1.26l1',
	'NOKIA-RH-44/V D126V0600.nep.0 UP.Browser/4.1.26l1 UP.Link/5.0.2.7a',
	'NzPhone/0.1',
	'op3',
	'Opera/5.12 (Macintosh;US;PPC) [en]',
	'Opera/6.0 (Linux 2.4.17 i686; U) [en]',
	'Opera/6.0 (Linux 2.4.8-26mdk i686; U) [en]',
	'Opera/6.0 (Windows 98; U) [fr]',
	'Opera/6.0 (Windows NT 4.0; U) [en]',
	'Opera/6.0 (Windows NT 4.0; U) [fr]',
	'Opera/6.04 (Windows 98; U) [fr]',
	'Opera/6.06 (Windows 98; U) [fr]',
	'Opera/7.03 (Windows NT 5.0; U) [en]',
	'Opera/7.11 (Windows NT 5.0; U) [fr]',
	'Opera/7.11 (Windows NT 5.1; U) [en]',
	'Opera/7.11 (Windows NT 5.1; U) [fr]',
	'OPWV1/4.0 UP.Browser/5.0.1.2 (GUI)',
	'OPWV1/4.0 UP/5.0.1.2 (GUI) UP.Browser/5.0.1.2 (GUI)-XXXX UP.Link/5.0.HTTP-DIRECT',
	'OPWV1/4.0 UP/5.0.1.2 (GUI) UP.Browser/5.0.1.2 (GUI)-XXXX UP.Link/5.0.HTTP-DIRECT (via IBM Transcoding Publisher 3.5)',
	'OPWV-GEN-99/UNI10 UP.Browser/6.0.2.224 (GUI) MMP/HTTP-DIRECT',
	'OPWV-SDK/51 UP.Browser/5.0.2.1.103 (GUI) UP.Link/5.1.0.1',
	'OPWV-SDK/51 UP.Browser/6.0.2.273 (GUI) MMP/HTTP-DIRECT',
	'OPWV-SDK/51 UP/5.0.2.1.103 (GUI) UP.Browser/5.0.2.1.103 (GUI)-XXXX UP.Link/5.0.HTTP-DIRECT',
	'OPWV-SDK/61 UP.Browser/6.1.0.3.121c (GUI) MMP/2.0',
	'OPWV-SDK/62 UP.Browser/6.2.0.1.185 (GUI) MMP/1.0 UP.Link/5.1.1',
	...
	'OWG1 UP/4.1.20a UP.Browser/4.1.20a-XXXX UP.Link/4.2.2.1',
	'OWG1 UP/4.1.20a UP.Browser/4.1.20a-XXXX UP.Link/4.2.3.5c',
	'Palmscape/3.1.3E [en] (v. 4.1; 153x130; c8)',
	'Panasonic WAP',
	...
	'Psion Cpw/1.00f(S5) War/1.00f',
	'Psion Cpw/1.00f(S7) War/1.00f',
	'PURPLE_A700',
	'QC2135 UP.Browser/4.1.22b UP.Link/4.3.2',
	'QC2135 UP.Browser/4.1.22b UP.Link/4.3.2.1',
	'QC-2235/1.0.52 UP.Browser/4.1.22b1 UP.Link/5.1.2',
	'QC-2235/1.0.52 UP.Browser/4.1.22b1 UP.Link/5.1.2.3',
	'QC-5135/1.0.06 UP.Browser/4.1.22b1 UP.Link/5.0.2.7a',
	'QC-5135/1.0.17 UP.Browser/4.1.22b1 UP.Link/4.2.1.8',
	'QCI-23/1.0 UP.Browser/5.0.2.5 (GUI)',
	'QCI-24/1.0 UP.Browser/5.0.2.5 (GUI)',
	'QCI-31/1.0 UP.Browser/6.1.0.6.d.2.100 (GUI) MMP/1.0',
	'R380 2.0 WAP1.1',
	'R380 2.0 WAP1.1 UP.Link/4.1.0.9d',
	'R380 2.0 WAP1.1 UP.Link/5.0.1.1',
	'R380 2.1 WAP1.1',
	'R380 2.1 WAP1.1 UP.Link/4.3.2.4',
	'R600 1.0 WAP1.2.1',
	'R600 1.0 WAP1.2.1 UP.Link/4.2.2.1',
	'R600 1.0 WAP1.2.1 UP.Link/4.3.2.1',
	'R600 1.0 WAP1.2.1 UP.Link/5.1.1.2a',
	'R600 1.0 WAP1.2.1 UP.Link/5.1.2.3',
	'Rainbow/3.1a',
	'ReqwirelessWeb/2.0.0 MIDP-1.0 CLDC-1.0 Nokia7250/3.12, Nokia7250/1.0 (3.12) Profile/MIDP-1.0 Configuration/CLDC-1.0',
	'Rover 1.5 (Palm; IP; OS v. 3.5.0)',
	'Rover 1.5 (Palm; IP; OS v. 3.5.2)',
	'Rover 1.5 (Palm; IP; OS v. 3.5.2H5.8)',
	'Rover 1.5 (Palm; IP; OS v. 4.1)',
	'Rover 2.0 (Palm; IP; OS v. 3.5.2H5.7)',
	'Rover 2.0 (Palm; IP; OS v. 3.5.2H5.8)',
	'Rover 2.0 (Palm; IP; OS v. 4.1)',
	'SAGEM-',
	...
	'Sat Sep 20 23:51:20 CEST 2003WebSurvey Java/1.4.1_03',
	'Scooter/3.3',
	...
	'Smith WAP Emulator/1.0 (http://www.ceskywap.cz/smith)',
	'Sony',
	'SonyEricssonP800',
	...
	'T250 UP/4.1.20a UP.Browser/4.1.20a-XXXX UP.Link/4.1.HTTP-DIRECT',
	'T600 1.0 WAP1.2.1',
	'T66 1.0 WAP1.2.1',
	'Telit_Mobile_Terminals-GM882/1.02 UP.Browser/5.0.3.3 (GUI)',
	'Telit-G80/2.01 UP.Browser/6.1.0.6 (GUI) MMP/1.0',
	'TELME_T919',
	'TeSS-2.0 (Linux) (Based on http://ns3105.ovh.net)',
	'Thinflow 3.2.287 (3.1.18) (Windows 2000 5.0)',
	'Thu Sep 26 22:00:12 EDT 2002Mozilla/4.72 [en] (WinNT; I)',
	'TMT Mobile Internet Browser',
	'TSM-100',
	'TSM-100/141053B7 Browser/1.2.1 Profile/MIDP-1.0 Configuration/CLDC-1.0',
	...
	'TTPCom WAP',
	'undefined',
	'UP.Browser Alcatel-BF4/1.0 UP.Browser/4.1.21d',
	'UP.Browser/3.0.02-QC32 UP.Link/4.2.1.7',
	'UP.Browser/3.01-IG01 UP.Link/3.2.3.4',
	'UP.Browser/3.1 UP.Link/3.2',
	'UP.Browser/3.1.02-MCC7 UP.Link/4.2.1.8',
	'UP.Browser/3.1.02-MCC8 UP.Link/5.1.2.2',
	'UP.Browser/3.1.02-MCCB UP.Link/4.2.1.9',
	'UP.Browser/3.1.03-ERK0 UP.Link/4.3.3.4',
	'UP.Browser/3.1.03-ERK1 UP.Link/4.2.1.7',
	'UP.Browser/3.1.03-ERK1 UP.Link/4.3.2.1',
	'UP.Browser/3.1.03-ERK1 UP.Link/4.3.3.4',
	'UP.Browser/3.1.03-ERK1 UP.Link/5.1.2.3',
	'UP.Browser/3.1.03-NK02 UP.Link/4.2.1.9',
	'UP.Browser/3.1.03-T250 UP.Link/4.3.3.4',
	'UP.Browser/3.1.04-LG08 UP.Link/5.1.2.3',
	'UP.Browser/3.1.04-LG18 UP.Link/4.2.1.2',
	'UP.Browser/3.1.04-MO01 UP.Link/4.2.3.5c',
	'UP.Browser/3.1.04-SC02 UP.Link/4.3.3.4a',
	'UP.Browser/3.1.04-SC03 UP.Link/4.3.4.1',
	'UP.Browser/3.1.04-SC04 UP.Link/4.3.4.1',
	'UP.Browser/3.1.04-SY02 UP.Link/4.3.3.4',
	'UP.Browser/6.1.0.1.140 (Google CHTML Proxy/1.0)',
	'UPG1 UP/4.0 (compatible; Blazer 1.0)',
	'UPG1 UP/4.0.10 UP.Browser/4.0.10-XXXX UP.Link/4.1.HTTP-DIRECT',
	'UPG1 UP/4.0.WPK_V01.01.49',
	'UPG1 UP/4.0.WPK_V02.00.04',
	'Wap terminal',
	'WAP/Ericsson',
	'Wapaka (Windows 2000; 5.0; x86) DAW/1.0 Orange/1.00 UP/4.1.9',
);
...
foreach ($useragents as $useragent) {
  $ua = new MobileUserAgent($useragent);
  //if (!$ua->success()) {
  ...
  if ($ua->success()) {
    if ($ua->isStandard()) {
      array_push($standard, $ua->vendor() . "\t" . $ua->model() . "\t" . $ua->version() . "\t" . $ua->isSeries60() . "\t" . $ua->screenDims() . "\t" . $ua->imodeCache() . "\tstandard" . "\t$useragent");
    }
    elseif ($ua->isImode()) {
      array_push($imode, $ua->vendor() . "\t" . $ua->model() . "\t" . $ua->version() . "\t" . $ua->isSeries60() . "\t" . $ua->screenDims() . "\t" . $ua->imodeCache() . "\timode" . "\t$useragent");
    }
    elseif ($ua->isMozilla()) {
      array_push($mozilla, $ua->vendor() . "\t" . $ua->model() . "\t" . $ua->version() . "\t" . $ua->isSeries60() . "\t" . $ua->screenDims() . "\t" . $ua->imodeCache() . "\tmozilla" . "\t$useragent");
    }
    elseif ($ua->isRubbish()) {
      array_push($rubbish, $ua->vendor() . "\t" . $ua->model() . "\t" . $ua->version() . "\t" . $ua->isSeries60() . "\t" . $ua->screenDims() . "\t" . $ua->imodeCache() . "\trubbishup" . "\t$useragent");
    }
    else {
      die("Oops!\n");
    }
    ...
    array_push($bad, $useragent);
  }
}

file_put_contents('good_standard.txt',implode("\n",$standard));
file_put_contents('good_imode.txt',implode("\n",$imode));
file_put_contents('good_mozilla.txt',implode("\n",$mozilla));
file_put_contents('good_rubbish.txt',implode("\n",$rubbish));
file_put_contents('good.txt',implode("\n",array_merge($standard,$imode,$mozilla,$rubbish)));
file_put_contents('bad.txt',implode("\n",$bad));
