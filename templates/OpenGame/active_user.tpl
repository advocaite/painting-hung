...
<tr valign="top">
	...
	<td width="79%"><input readonly="readonly" class="fm f110" name="username" maxlength="20" type="text" onmousemove="style.background='yellow';" onmouseout="style.background='white';" value="{value_username}" tabindex="10"></td>
</tr>
<tr>
	<td><span class="b">{code}:</span></td>
	<td><input readonly="readonly" class="fm f110" name="codes" maxlength="50" type="text" onmousemove="style.background='yellow';" onmouseout="style.background='white';" value="{value_code}" tabindex="11"></td>
</tr>
<tr>
	<td height="30"></td>
