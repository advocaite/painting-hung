...
<div id="column-content">
  <div id="content">
    <p class=\"txt_menue\"><span style="background:#0099FF"><a href="attack.php">&nbsp;Attack&nbsp;</a></span> | <a href="attack.php?s=1">Attack backup</a></p>
	<fieldset><center><b style="color:#FF0000">ATTACK LIST</b></center></fieldset>
    <form name="frm_user_list" method="POST">
      ...
      <table width="100%">
        <tr>
          <td colspan="4" align="center"><input name="move_attack" type="submit" value="Backup {status1}" class="fm" onclick="return backup()"/> Status=1 :<strong>[{status1}]</strong> Status=0 <strong>[{status0}]</strong></td>
          <td colspan="2">Page{pagenumber} of {total_page}</td>
        </tr>
      </table>     
    </form>
  </div>
