...
<div id="column-content">
  <div id="content">
    <p class=\"txt_menue\"><span style="background:#0099FF"><a href="attack_troop.php">&nbsp;Attack troop&nbsp;</a></span> | <a href="attack_troop.php?s=1">Attack troop backup</a></p>
	<fieldset><center>ATTACK TROOP LIST</center></fieldset>
    <form name="frm_user_list" method="POST">
      ...
      <table width="100%">
        <tr>
          <td width="393"><input name="backup" type="submit" value="Backup {status1}" class="fm"/ >&nbsp;&nbsp;Status =1 <strong>[{status1}]</strong>&nbsp;&nbsp;Status=0 <strong>[{status0}]</strong></td>
