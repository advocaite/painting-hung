<div id="column-content">
    <div id="content">
	<div><a href="map_troops.php">&nbsp;Wg_troops&nbsp;</a> | <span style="background: rgb(0, 153, 255) none repeat scroll 0% 0%;"><a href="map_troops.php?s=1">Help troops</a></span></div>
...
<fieldset><center><input name="radiobutton" onclick="setTypingMode(4)" checked="checked" type="radio">Bật bộ gõ tiếng Việt&nbsp;<input name="radiobutton" onclick="setTypingMode(0)" type="radio"> Tắt&nbsp;&nbsp;&nbsp;<select name="select_name" class="fm" style="width:180px;height=40px;" onchange="javascript:window.open('map_troops.php?s=1&id='+this.options[this.selectedIndex].value,'_top')">
{option}
