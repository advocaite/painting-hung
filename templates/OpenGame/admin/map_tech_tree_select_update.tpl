    ...
    <div id="content">
        <form action="">
            <table border="1" width="80%" align="center">
                ...
                <tr>
                    <th align="right"><font color="red">{select_tech_check}</font></th>
                    <th align="right">{name_tech_building}</th>
                    <th align="right">{name_tech_level}</th>
                    <th align="right">{name_tech_res}</th>
                </tr>
                {list_select}
                <tr>
                    <td align="center" colspan="4"><input id="select_tech_update" name="select_tech_update" type="submit" value="{select_tech_update_valu}">
                    </td>
                </tr>
            </table>
            <div style="display:none">
                <input id="update_ok_id" name="update_ok_id" value="{update_ok_id_valu}" type="hidden">
                <table>
                    <tbody>
                        <tr>
