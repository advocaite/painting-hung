    ...
    <div id="content">
        <form action="">
            <table align="center" width="80%" border="1">
                ...
                {views_list}
                <tr>
                    <td align="center" colspan="10"><input id="ok_check_save" name="ok_check_save" type="submit" value="{ok}">
                    </td>
                </tr>
                </tbody>
                ...
                <table>
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><input id="valu_time_train" name="valu_time_train" value="{valu_time_train}" type="text"></td>
                            <td></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td colspan="2" align="center"><input type="submit" id="save" name="save" value="{save}">
