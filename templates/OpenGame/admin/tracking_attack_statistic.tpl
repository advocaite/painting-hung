...
function OpenWindowsNew(reportAttackId)
{
	return window.open('report_attack_popup.php?raid='+reportAttackId,'Report attack detail','toolbar=yes,location=yes,directories=yes,status=no,menubar=no,scrollbars=yes,resizable=yes,width=500,height=200,top=200,left=150');
}  
</script>

<div id="column-content">
    <div id="content">
      <p><a href="tracking.php">{Same PC}</a> | <a href="tracking.php?s=1">{Report Statistic}</a><!-- | <a href="tracking.php?s=2">{Resource Statistic}</a> | <span style="background:#FFCC66"><a href="tracking.php?s=3">{Attack Statistic}</a></span> | <a href="tracking.php?s=7">{Message}</a>--></p>
        <form method="POST" name="form_attack" action="tracking.php?s=3">
            <table>
                <tr>
                    <td colspan="7" align="center"><b style="color:#FF0000">ATTACK STATISTIC</b></td>
                </tr>
                <tr>
                    <td> From user: </td>
                    ...
                    <td> | <a href="tracking.php?s=3&t=reset_attack_report"> <b>Reset </b> </a> </td>
                </tr>
            </table>            
            ...
            <table cellspacing="1" cellpadding="2" width="100%" border="1">
                <tr>
                    ...
                    <th width="30%">User attack - User defend</th>
                    <th width="15%" >{Time}</th>
                </tr>
                {list}
            </table>
