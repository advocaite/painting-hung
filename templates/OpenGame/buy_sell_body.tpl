...
<body>
<table><tr><td>
<form action="build.php?id={id}&t=8&l={l}" method="post">
<div class="buysell_container">
<div class="header_title">
	<li><a href="build.php?id={id}&t=8&l=1">{Lumber}</a></li>
    <li><a href="build.php?id={id}&t=8&l=2">{Clay}</a></li>
    <li><a href="build.php?id={id}&t=8&l=3">{Iron}</a></li>
    <li><a href="build.php?id={id}&t=8&l=4">{Crop}</a></li>
</div>
