...
<!--<div><input name="radiobutton" onClick="setTypingMode(4)" type="radio">Bật bộ gõ tiếng Việt&nbsp;<input name="radiobutton" onClick="setTypingMode(0)" type="radio" checked > Tắt</div>-->
<br />
{error}
