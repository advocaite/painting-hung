    ...
    <form name="frm_profile_edit" method="POST" action="profile.php?s=1&act=1">
      ...
      <table cellspacing="1" cellpadding="2" class="tbg">
        ...
        <tr>
          ...
          <td width="48%" class="s7"><input type="text" class="fm" name="date" id="date" maxlength="2" size="5" value="{date}" onkeyup="CheckNumberInput(this);">
            ...
            <input type="text" class="fm" name="year" id="year" maxlength="4" size="5" value="{year}" onkeyup="CheckNumberInput(this);">
          </td>
          <td rowspan="11"><textarea name="description"   cols="27" rows="12" class="f10 fm_text">{description_edit}</textarea></td>
        </tr>
        <tr class="s7">
          <td>{Gender}:</td>
          <td><input type="Radio" name="sex" value="1" {check_male} />
            {m}
            <input type="Radio" name="sex" value="0" {check_female}>
            {f} </td>
        </tr>
        <tr class="s7">
          <td>{Position}:</td>
		...
		<tr class="s7">
          <td>{Phone}:</td>
          <td><input name="phone" type="text" maxlength="13" class="fm" value="{phone}" onkeyup="CheckNumberInput(this);"/></td>
        </tr>
        <tr>
