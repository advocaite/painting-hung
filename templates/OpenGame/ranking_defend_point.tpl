<form method="post" action="ranking.php?tab=3" name="frm_player">
<p>{error}
<table width="70%" cellspacing="1" cellpadding="2" class="tbg">
<tr class="rbg">
<td class="rbg" colspan="1">{sum_player}</td>
<td class="rbg" colspan="4"><a name="h2"></a>{rank_defent}</td>
</tr>
<tr>
	<td width="6%" >&nbsp;</td>
	<td width="35%">{Player}</td>
	<td width="25%">{Alliance}</td>
	<td width="20%">{defend_point}</td>
...
<td width="75">{Rank}:</td>
<td width="59"><input class="fm f30" type="Text" id="rank" name="rank" value="{rank_user}" maxlength="5" size="5" onfocus="document.getElementById('name').value='';" onkeyup="CheckNumberInput(this);"></td>
