...
X:
<input class="fm" type="Text" name="x" value="{x}" size="2" maxlength="4" tabindex="6" onkeyup="CheckNumberInput(this);">
Y:
<input class="fm" type="Text" name="y" value="{y}" size="2" maxlength="4" tabindex="7" onkeyup="CheckNumberInput(this);">
</span></td>
</tr>
