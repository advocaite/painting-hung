...
<td class="s7"><a href="village_map.php?a={village_defend_x}&b={village_defend_y}"><b>{village_defend_name}</b> (<b>{village_defend_x}</b>|<b>{village_defend_y}</b>)</a></td>
</tr>
<tr>
<td width="45%">{Player}</td>
...
<p>{mess}</p>
<p>
<input type="image" value="ok" border="0" name="s1" src="images/en/b/ok1.gif" width="50" height="20" onMousedown="btm1('s1','','images/en/b/ok2.gif',1)" onMouseOver="btm1('s1','','images/en/b/ok3.gif',1)" onMouseUp="btm0()" onMouseOut="btm0()"></input></form></p>