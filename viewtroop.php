...
{
	$path="xml/troopvn0.xml";
	if($_GET['id'] > 0 && $_GET['id'] <= 33)
	{
  ...
  <area shape="circle" coords ="12,9,10" href="viewtroop.php?id='.($_GET['id']-1).'"/><area shape="circle" coords ="43,6,10" href="viewtroop.php?id=0"/>
  <area shape="circle" coords ="73,8,10" href="viewtroop.php?id='.($_GET['id']+1).'"/></map></center></div>';
		$path="xml/troopvn".$_GET['id'].".xml";
	}
